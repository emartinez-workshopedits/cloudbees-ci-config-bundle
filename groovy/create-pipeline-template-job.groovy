...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/emartinez-workshopedits/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>emartinez-workshopedits</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>emartinez-workshopedits</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/emartinez-workshopedits/pipeline-template-catalog.git</repositoryUrl>
              <traits>
